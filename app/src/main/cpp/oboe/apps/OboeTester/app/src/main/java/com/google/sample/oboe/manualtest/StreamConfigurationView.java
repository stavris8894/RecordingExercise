...
public class StreamConfigurationView extends LinearLayout {
    ...
    private void initializeViews(Context context) {
        ...
        mChannelConversionBox.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mFormatConversionBox.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mRequestedMMapView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mRequestedExclusiveView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mRequestAudioEffect.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private class NativeApiSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
    ...
    private class PerformanceModeSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
    ...
    private class ChannelCountSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
    ...
    private class SampleRateSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
    ...
    private class FormatSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
    ...
    private class InputPresetSpinnerListener implements AdapterView.OnItemSelectedListener {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            String text = parent.getItemAtPosition(pos).toString();
