...
import com.google.sample.oboe.manualtest.ExponentialTaper;
...
public class BufferSizeView extends LinearLayout {
    ...
    private void initializeViews(Context context) {
        ...
        mBufferSizeRadio1.setOnClickListener(new OnClickListener() {
            @Override
        ...
        mBufferSizeRadio2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mBufferSizeRadio3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
